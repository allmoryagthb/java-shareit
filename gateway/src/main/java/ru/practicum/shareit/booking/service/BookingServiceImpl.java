...
import ru.practicum.shareit.server.booking.dto.BookingDtoInput;
import ru.practicum.shareit.server.booking.dto.BookingDtoOutput;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto addBooking(BookingDtoInput bookingDtoInput, Long bookerId) {
        ru.practicum.shareit.user.model.User user = getUser(bookerId);
